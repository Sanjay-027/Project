...
const Footer = () => {
  return (
    <footer className="bg-primary text-gray-300 py-8 mt-12">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold text-white">CareerWave</h2>
            <p className="text-sm">Connect. Apply. Grow.</p>
          </div>

          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://facebook.com" className="hover:text-secondary" aria-label="Facebook">
            ...
            <a href="https://twitter.com" className="hover:text-secondary" aria-label="Twitter">
            ...
            <a href="https://linkedin.com" className="hover:text-secondary" aria-label="LinkedIn">
